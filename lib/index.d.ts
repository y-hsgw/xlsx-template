...
declare class XlsxTemplate {
  ...
  public generate<T extends XlsxTemplate.GenerateType>(
    options: XlsxTemplate.GenerateOptions<T>,
  ): XlsxTemplate.OutputByType[T];
  public generate(): any;
  ...
  public substituteScalar(
    cell: any,
    string: string,
    placeholder: XlsxTemplate.TemplatePlaceholder,
    substitution: any,
  ): string;
  ...
  public extractPlaceholders(
    templateString: string,
  ): XlsxTemplate.TemplatePlaceholder[];
  ...
  protected loadSheet(sheet: any): {
    filename: any;
    name: any;
    id: any;
    root: any;
  }; // this could definitely return a "Sheet" interface/class
  ...
  protected writeRichDataAlreadyExist(
    element: etree.ElementTree,
    elementSearchName: string,
